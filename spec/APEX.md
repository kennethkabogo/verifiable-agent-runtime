...
- `SESSION_RESUME` (0x07) — 93-byte VARS scope, segment-2 keypair
...
161-byte VARE scope (§5.5) with `SHA-256(b"")` in the payload-hash field.
...
| Field | Value |
|:------|:------|
| **Sig[1]** | **`c8541ab7903b2b00973171c35451069bae23fbd9475c38d33014b8ae9a53caa160d66d3665e74acf6baf937cdeb3145abe18e8636dc9ada40d0ba4817a9b1403`** |
...
VARE scope as §14.6 but with updated PrevL1Hash and L1Hash.
...
```
  56 41 52 45 01 02 00 00 00 00 00 00 00 e4 5c 89
  7e be 0f e8 4f 41 fb 3f ed da 6b 69 e8 e0 1c 99
...
| Field | Value |
|:------|:------|
| **Sig[2]** | **`1347d8299b94fe9596bbeb84ecb012d4cfa2db42cc341ba94712fabe758364225c725a06a57041a6c57d26ab1ad5858d86c4042e226979f353d2a90bc5e61e06`** |
...
the sealed checkpoint (§9.5). Uses a 137-byte **VART** scope — distinct
from the VARE scope to prevent cross-packet signature confusion.
...
**TEMPORAL_PROOF signature scope (137 bytes, VART magic):**

| Offset | Size | Field | Value |
|-------:|-----:|:------|:------|
| 0 | 4 | Magic (`"VART"`) | `56415254` |
| 4 | 1 | FormatVer | `01` |
...
```
  56 41 52 54 01 03 00 00 00 00 00 00 00 68 b3 9d
  a0 21 3e b4 ef 7a cc 70 82 a6 89 fd df 3c d7 5b
...
| Field | Value |
|:------|:------|
| **Sig[3]** | **`e7c914b5cd116691bee6c89fb4f64f9aa20ecf1449fe8474131b0a1dca920e44a6698dc9b97cc4943098c4ecff6a2fe4accf61a0696c04fd1651905769531105`** |
...
```
TEMPORAL_PROOF:prev_stream=68b39da0213eb4ef7acc7082a689fddf3cd75b315124f789b1543036c6e82a8f:stream=f972ac032fff65740dee0be839b86c5528161c393ce298f9cc4e9611f406ba1f:proof=32a4a37d9f56d5027485b38fc65e5865698cab7379d56b6c4f44763dfd2e5f3f:m=65536:t=3:p=1:sig=e7c914b5cd116691bee6c89fb4f64f9aa20ecf1449fe8474131b0a1dca920e44a6698dc9b97cc4943098c4ecff6a2fe4accf61a0696c04fd1651905769531105:seq=3
```

```
TemporalProofHash = SHA-256(wire_line_bytes)
                 = f44f97486c14755c5db2e192e8a126855c0c8d932efce463edae264614acff4e
```
...
**SESSION_RESUME signature scope (93 bytes, VARS magic):**

| Offset | Size | Field | Value |
|-------:|-----:|:------|:------|
| 0 | 4 | Magic (`"VARS"`) | `56415253` |
| 4 | 1 | FormatVer | `01` |
...
```
  56 41 52 53 01 04 00 00 00 00 00 00 00 f9 72 ac
  03 2f ff 65 74 0d ee 0b e8 39 b8 6c 55 28 16 1c
...
| Field | Value |
|:------|:------|
| **Sig[4]** | **`9986abf59f69cdc2e2f11eed189c93a1b9bcd0816599aff609186ac6338e4518bb803cd10cf0be70b3059b079077fb7ce7cb6ef260df0fa1c7da10d20fef1605`** |
...
| Field | Value |
|:------|:------|
| Sig[1] (SESSION_START) | `c8541ab7903b2b00973171c35451069bae23fbd9475c38d33014b8ae9a53caa160d66d3665e74acf6baf937cdeb3145abe18e8636dc9ada40d0ba4817a9b1403` |
| Sig[2] (EVIDENCE) | `1347d8299b94fe9596bbeb84ecb012d4cfa2db42cc341ba94712fabe758364225c725a06a57041a6c57d26ab1ad5858d86c4042e226979f353d2a90bc5e61e06` |
| Sig[3] (TEMPORAL_PROOF) | `e7c914b5cd116691bee6c89fb4f64f9aa20ecf1449fe8474131b0a1dca920e44a6698dc9b97cc4943098c4ecff6a2fe4accf61a0696c04fd1651905769531105` |
| Sig[4] (SESSION_RESUME) | `9986abf59f69cdc2e2f11eed189c93a1b9bcd0816599aff609186ac6338e4518bb803cd10cf0be70b3059b079077fb7ce7cb6ef260df0fa1c7da10d20fef1605` |
| **TerminalDigest** | **`505275b64086df9a5f7b6ea290a83cb0eb4590e665054b10b41f1fd3999ea694`** |
...
```
BundleHash = SHA-256("VARB" ‖ SessionID ‖ BootstrapNonce ‖ PubB ‖ TerminalDigest)
...
| TerminalDigest | `505275b64086df9a5f7b6ea290a83cb0eb4590e665054b10b41f1fd3999ea694` |
| **BundleHash** | **`07257f742a0cf8f9e9e6021be444213257b00f0bea27a5859013996e84d23dfe`** |
| **SealSig** | **`93d99093f4e91d282be28a76ee50d3894beb812a7200ec93ed23764906a718216bd14f998c8cc553595f534f3886a4bdee555ec629673c47de7cbde384dd360b`** |
...
| 56 | 32 | TerminalDigest | `505275b64086df9a5f7b6ea290a83cb0eb4590e665054b10b41f1fd3999ea694` |
| **88** | | **total** | |
...
| Field | Value |
|:------|:------|
| **SettlementSig** | **`2cb371bb72028dfff6689973fc11d3deef991691437f293601e72da10056ac3d352e09c81e9337d13e913e54d1bf57f347811dbb8aa4b22dda3e4b21ceabd407`** |
...
| TemporalProofHash | `f44f97486c14755c5db2e192e8a126855c0c8d932efce463edae264614acff4e` |
| Sig[1] SESSION_START | `c8541ab7903b2b00973171c35451069bae23fbd9475c38d33014b8ae9a53caa160d66d3665e74acf6baf937cdeb3145abe18e8636dc9ada40d0ba4817a9b1403` |
| Sig[2] EVIDENCE | `1347d8299b94fe9596bbeb84ecb012d4cfa2db42cc341ba94712fabe758364225c725a06a57041a6c57d26ab1ad5858d86c4042e226979f353d2a90bc5e61e06` |
| Sig[3] TEMPORAL_PROOF | `e7c914b5cd116691bee6c89fb4f64f9aa20ecf1449fe8474131b0a1dca920e44a6698dc9b97cc4943098c4ecff6a2fe4accf61a0696c04fd1651905769531105` |
| Sig[4] SESSION_RESUME | `9986abf59f69cdc2e2f11eed189c93a1b9bcd0816599aff609186ac6338e4518bb803cd10cf0be70b3059b079077fb7ce7cb6ef260df0fa1c7da10d20fef1605` |
...
| Version | Changes |
|:---|:---|
| 2.5.0 | §14.9 two-segment session test vectors added: SESSION_START (0x06) 161-byte VARE scope, TEMPORAL_PROOF (0x09) 137-byte VART scope with Argon2id SWF, SESSION_RESUME (0x07) 93-byte VARS scope, four-packet TerminalDigest, two-keypair bundle seal; gen_fixture_14n.py generation script; §14.1 "Planned" stub replaced with §14.9 reference |
